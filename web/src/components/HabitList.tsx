...
import { useHabitsInfo } from '../hooks/habitsInfo';
import { IHabitList } from '../interfaces/habitList';

export const HabitList = ({ date, onCompletedChanged }: IHabitList) => {
  const { habitsInfo, handleToggleHabit } = useHabitsInfo({ date, onCompletedChanged });
